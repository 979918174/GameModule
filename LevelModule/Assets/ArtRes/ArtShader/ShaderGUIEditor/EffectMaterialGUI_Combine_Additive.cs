...
/// 
/// </summary>
internal class EffectMaterialGUI_Combine_Additive : ShaderGUI
{
    //深度检测
    ...
    private static class Styles
    {
        ...
        public static GUIContent useCustomData1xy = EditorGUIUtility.TrTextContent("Use CustomData1 xy", "是否使用CustomData1.xy控制UV偏移");
        //菲涅尔效果
        ...
        public static GUIContent useDissolveCustomData1Label = EditorGUIUtility.TrTextContent("Dissolve Range Use CustomData[CustomData.z]", "是否启用range的CustomData1.z");
